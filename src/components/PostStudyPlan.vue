...
const getPlaceholderCourseCode = (courseNameTH: string): string | null => {
    ...
    const mappings: { [key: string]: string } = {
        'วิชาภาษาไทย': '12230000', // ตัวอย่าง
        'วิชาภาษาต่างประเทศ 1 ภาษา (1)': '12240001',
        'วิชาภาษาต่างประเทศ 1 ภาษา (2)': '12240002',
        'วิชาภาษาต่างประเทศ 1 ภาษา (3)': '12240003',
        'กิจกรรมพลศึกษา': '01175xxx', // ตัวอย่าง Placeholder
        'วิชาศึกษาทั่วไปกลุ่มสาระศาสตร์แห่งผู้ประกอบการ': '01310000', // ตัวอย่าง
        'วิชาศึกษาทั่วไปกลุ่มสาระสุนทรียศาสตร์': '01320000', // ตัวอย่าง
        'วิชาศึกษาทั่วไปกลุ่มสาระอยู่ดีมีสุข': '01330000', // ตัวอย่าง
        'วิชาศึกษาทั่วไปใน 5 กลุ่มสาระ (1)': '01340001',
        'วิชาศึกษาทั่วไปใน 5 กลุ่มสาระ (2)': '01340002',
        'วิชาศึกษาทั่วไปกลุ่มสาระพลเมืองไทยและพลเมืองโลก': '01350000', // ตัวอย่าง
        'วิชาสารสนเทศ/คอมพิวเตอร์': '01418000', // ตัวอย่าง Placeholder กลาง?
